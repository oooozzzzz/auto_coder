...
const CanvasElement: React.FC<{
    ...
    return (
        <div
            ref={elementRef}
            className={`absolute border-2 bg-white cursor-move select-none ${isSelected
...
const CanvasDropZone: React.FC<{
    ...
    return (
        <div
            ref={setRefs}
            className={`relative border-2 border-dashed bg-white ${isOver ? 'border-blue-400 bg-blue-50' : 'border-gray-300'
                }`}
            style={{
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 border-b border-gray-200">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <button
                        ...
                        className={`px-3 py-1 text-sm border rounded ${showGrid
